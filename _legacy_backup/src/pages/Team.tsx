...
export default function Team() {
    ...
    useEffect(() => {
        const fetchTeamData = async () => {
            ...
            // Mock barbers for Step 3 if DB is empty
            const finalProfiles = (!profiles || profiles.length === 0) ? [
                { id: 'b1', nome: 'Beto Silva', cargo: 'barber', especialidade: 'Colorimetria', comissao_pct: 50 },
                { id: 'b2', nome: 'Lucas Ferreira', cargo: 'barber', especialidade: 'Barba & Bigode', comissao_pct: 45 }
            ] : profiles;
