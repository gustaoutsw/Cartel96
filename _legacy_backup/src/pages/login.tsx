...
import { Scissors, ShieldCheck, Zap, ArrowRight, Lock, Mail } from 'lucide-react';
...
export default function Login() {
    ...
    const handleLogin = (e: React.FormEvent) => {
        e.preventDefault();
        setLoading(true);
        // Instant login for the user experience (can be swapped for real Supabase login)
        setTimeout(() => {
            if (email === 'gustavo@cartel96.com' || email.includes('admin')) {
